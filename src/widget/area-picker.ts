...
function startAreaPicker(
  ...
  const cancelButton = tooltip.querySelector<HTMLButtonElement>('#wti-area-picker-cancel');
...
function createOverlay(): HTMLDivElement {
  ...
  overlay.id = 'wti-area-picker-overlay';
...
function createSelectionBorder(
  ...
  selectionBorder.id = 'wti-area-picker-selection';
...
function createTooltip(
  ...
  tooltip.id = 'wti-area-picker-tooltip';
  ...
  if (showInlineCancel) {
    ...
    cancelButton.id = 'wti-area-picker-cancel';
