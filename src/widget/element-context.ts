const DEFAULT_SELECTED_ELEMENT_CONTEXT_MIN_PADDING_PX = 80;
const DEFAULT_SELECTED_ELEMENT_CONTEXT_MAX_VIEWPORT_AREA_MULTIPLIER = 0;

function resolveSelectedElementContextMaxArea(value?: number | null): number {
